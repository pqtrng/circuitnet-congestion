...
- Until the evaluation reported in the final section, no model output had
  touched the test split, but two of its target statistics had been computed and
  were cited in design rationales: the count of pixels
